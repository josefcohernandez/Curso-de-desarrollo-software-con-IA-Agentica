...
4. **Diseñar** documentación (archivo de instrucciones del repositorio, ADRs) que funcione como contrato bidireccional con el agente
...
| 4 | [04-documentacion-como-contrato.md](teoria/04-documentacion-como-contrato.md) | Archivo de instrucciones del repositorio como contrato bidireccional y ADRs asistidos por IA | 15 min |
...
| 3 | [03-documentar-para-ia.md](ejercicios/03-documentar-para-ia.md) | Crear un archivo de instrucciones completo y verificar que el agente produce mejor código | 20 min |
...
- **Documentación como contrato**: archivo de instrucciones del repositorio y reglas por tema como acuerdos bidireccionales
